...
public class ClinicServiceImpl implements ClinicService {
    ...
    public List<ClinicDTO> findFreeClinics(AvailableDoctorRequest adr) {
        ...
        List<Clinic> clinics = this.clinicRepository.getFreeClinics(adr.getIdExamType(),adr.getDate());
    ...
    public boolean isDoctorAbsent(AvailableDoctorRequest adr, Doctor doctor) {
