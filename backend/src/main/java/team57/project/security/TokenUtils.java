...
public class TokenUtils {
    ...
    public String generateToken(String email) {  //here we set the data that is stored in a token, and that data is an email, a date when the token is generated, and how long it lasts
        return Jwts.builder()
                .setIssuer(APP_NAME)
                .setSubject(email)
