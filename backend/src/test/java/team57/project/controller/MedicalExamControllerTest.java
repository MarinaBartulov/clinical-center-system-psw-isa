...
public class MedicalExamControllerTest {
    ...
    @MockBean
    private ClinicServiceImpl clinicServiceMocked;
    ...
    public void testGetExamRequest() throws Exception {
        ...
        p.setId(1L);
        Doctor d = new Doctor("Petar","Petrovic","petar@gmail.com","petar123","Gogoljeva 23","Novi Sad","Serbia","234234234","1231231231231");
        d.setId(2L);
        ...
        mockMvc.perform(get(URL_PREFIX+"/getExamRequest/1")
                ...
                .andExpect(jsonPath("$.examTypeName").value("Medical exam 1"))
    ...
    public void testGetExamRequests() throws Exception {
        ...
        mockMvc.perform(get(URL_PREFIX+"/getExamRequests/1")
                ...
                .andExpect(jsonPath("$.[*].examTypeName").value(hasItem("Medical exam 1")))
        ...
        public void testReserveRoom() throws Exception {
            ...
            Doctor d2 = new Doctor("Ivan","Ivanovic","ivan@gmail.com","ivan123","Gogoljeva 23","Novi Sad","Serbia","23423234234","1231231231111");
            d2.setId(2L);
            ...
            MedicalExamRequest mer1 = new MedicalExamRequest(m1); //request sent from the client with desired data
            MedicalExamRequest mer2 = new MedicalExamRequest(m1); // request sent from the client with possible data, something changed
            mer2.setDate(LocalDate.of(2020,12,2));
            mer2.setDoctor(new DoctorFA(d2)); //doctor changed
            ...
            String json = "{\"examStart\":{\"id\":1,\"date\":[2020,11,2],\"startTime\":[7,0],\"fullNamePatient\":\"Pera Peric\",\"doctor\":{\"id\":2,\"fullName\":\"Petar Petrovic\"},\"examTypeName\":\"Medical exam 1\",\"idExamType\":1},\"examEnd\":{\"id\":1,\"date\":[2020,12,2],\"startTime\":[7,0],\"fullNamePatient\":\"Pera Peric\",\"doctor\":{\"id\":2,\"fullName\":\"Ivan Ivanovic\"},\"examTypeName\":\"Medical exam 1\",\"idExamType\":1},\"roomME\":{\"id\":1,\"name\":\"Room 2\",\"number\":\"2\",\"date\":[2020,12,2],\"startTime\":[6,0],\"endTime\":[7,0],\"roomType\":\"Medical exam\"}}";
