...
public class RoomServiceTest {
    ...
    public void testFindRoomsFreeTermsPositive(){
        ...
        //find rooms which start with Ro and you get the first free term on that day for that doctor for every room that matches search
    ...
    public void testFindRoomsFreeTermsNegativeSearch(){
        ...
        //find rooms which start with blablabla and you get the first free term on that day for that doctor for every room that matches search
        List<RoomME> foundRooms = roomService.findRoomsFreeTerms(clinic,ftr);
