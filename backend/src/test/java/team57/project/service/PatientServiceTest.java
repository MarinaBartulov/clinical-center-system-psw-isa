...
public class PatientServiceTest {
    ...
    @MockBean
    private ClinicAdminServiceImpl clinicAdmin;
    ...
    public void sendAppointmentTest(){
        ...
        ExamType examType = new ExamType(1L,"TYPE1");
        ...
        Mockito.when(this.examTypeRepository.findByName("TYPE1")).thenReturn(examType);
