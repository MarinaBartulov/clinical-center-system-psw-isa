...
public class ExamTypesServiceTest {
    ...
    public void findAllTest(){
        ...
        ExamType e3 = new ExamType(3L,"THIRD");
    ...
    public void findOne(){
        ...
        assertThat(exam.getName()).isEqualTo("FIRST");
        assertThat(exam.getId()).isEqualTo(1L);
    }

    @Test
    public void findByNameTest(){
        ExamType e1 = new ExamType(1L,"TESTFIRST");

        Mockito.when(this.examTypeRepository.findByName("TESTFIRST")).thenReturn(e1);
        ExamType exam = this.examTypeService.findByName("TESTFIRST");

        assertThat(exam).isNotNull();
        assertThat(exam.getName()).isEqualTo("TESTFIRST");
        assertThat(exam.getId()).isEqualTo(1L);
