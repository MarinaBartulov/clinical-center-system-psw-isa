-- When you create the database for testing, comment the data in the first data.sql
...
-- TESTING - data for unit and integration tests

-- requests for medical exams without rooms
...
-- Free terms for rooms in the clinic for specific date and time
...
-- Free terms for doctors for a specific date
